        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CampaignSettings_AspNetUsers_OwnerUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SettingEntries_CampaignSettings_CampaignSettingId",
            ...
            migrationBuilder.CreateTable(
                name: "SettingEntryRelationships",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    CampaignSettingId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SettingEntryRelationships", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SettingEntryRelationships_CampaignSettings_CampaignSettingId",
                        column: x => x.CampaignSettingId,
                        principalTable: "CampaignSettings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CampaignSettings_OwnerUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SettingEntryRelationships_CampaignSettingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SettingEntryRelationships_TargetEntryId",
                table: "SettingEntryRelationships",
